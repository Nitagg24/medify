...
import icon6 from '../../assets/piscologist.png'; // Note: Should this be 'Psychologist'?
...
export default function Specialization() {
    const specializations = [
        ...
        { icon: icon6, title: 'Piscologist' }, // Confirm if 'Piscologist' is the correct term.
                ...
                <Grid container spacing={{ xs: 1, md: 3 }} mb={5} justifyContent="center">
                    {specializations.map((specialization, index) => (
                        <Grid item xs={6} sm={4} md={3} key={index}>
                            <IconCard img={specialization.icon} title={specialization.title} bgColor="#FFFFFF" shadow={true} />
                        </Grid>
                    ))}
                </Grid>
