      ...
      <Box sx={{ background: "linear-gradient(#EFF5FE, rgba(241,247,255,0.47))" }}>
        ...
        >
          <Container maxWidth="xl" sx={{ px: { xs: 0, md: 5 } }}>
            <Stack direction={{ xs: "column", md: "row" }} spacing={{ xs: 0, md: 12 }} alignItems="center">
              <Typography component="h1" pb={1} fontSize={{ xs: 32, md: 40 }} fontWeight={700} color="#fff">
                My Bookings
              </Typography>
              <Box
                bgcolor="#fff"
        ...
        <Container maxWidth="xl" sx={{ pt: 8, pb: 10, px: { xs: 0, md: 4 } }}>
          <Stack alignItems="flex-start" direction={{ md: "row" }}>
            ...
            >
              {filteredBookings.length > 0 ? (
                filteredBookings.map((hospital) => (
                  <HospitalCard key={hospital["Hospital Name"]} details={hospital} booking={true} />
                ))
              ) : (
            ...
            <img src={ctaImage} alt="Call to action" width={360} height="auto" />
          </Stack>
        </Container>
      </Box>
    </>
